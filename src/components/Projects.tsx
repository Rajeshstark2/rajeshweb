...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 relative">
      <div className="container mx-auto px-4">
        ...
        {/* Featured Projects */}
        <div className="mb-16">
          <h3 className="text-2xl font-orbitron font-semibold text-cyber-aqua mb-8 text-center">
            Featured Projects
          </h3>
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xl font-orbitron font-semibold text-white">{project.title}</h4>
  ...
  <a
    href="https://github.com/rajeshstark2" // <-- Replace with your actual GitHub URL
    target="_blank"
